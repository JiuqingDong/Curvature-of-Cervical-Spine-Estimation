...
class Network(object):
    ...
    def test(self, args, save):
        ...
        for cnt, data_dict in enumerate(data_loader):
            ...
            plt.savefig('./imgs/heatmap/{}'.format(img_id))
            plt.clf()
            plt.close()
...
#
            # cv2.imwrite("./imgs/regress/{}.png".format(img_id), ori_image_regress)
            # cv2.imwrite("./imgs/points/{}.png".format(img_id), ori_image_points)
