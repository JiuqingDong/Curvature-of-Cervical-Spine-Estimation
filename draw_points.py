import cv2
import numpy as np
colors = [[0.3856775, 0.94859286, 0.9910683],
           [0.3856775, 0.94859286, 0.9910683],
           [0.3856775, 0.94859286, 0.9910683],
           [0.3856775, 0.94859286, 0.9910683],
           [0.3856775, 0.94859286, 0.9910683],
          [0.3856775, 0.94859286, 0.9910683],
          ...
          [0.3856775, 0.94859286, 0.9910683],
          [0.3856775, 0.94859286, 0.9910683],
          [0.3856775, 0.94859286, 0.9910683],           # [0.93240442, 0.8993321, 0.09901344],
           [0.3856775, 0.94859286, 0.9910683],
          [0.3856775, 0.94859286, 0.9910683],
          [0.3856775, 0.94859286, 0.9910683],
          [0.3856775, 0.94859286, 0.9910683],
...
def draw_landmarks_regress_test(pts0, ori_image_regress, ori_image_points):
    for i, pt in enumerate(pts0):
        ...
        cv2.putText(ori_image_regress, '{}'.format(i + 1),
                    ...
                    1,
                    1)
        cv2.circle(ori_image_points, (int(pt[0]), int(pt[1])), 6, (255,255,255), -1,1)
